...
'''Utility for comparing a pair of LMChallenge log files, which were
generated by different models (or settings) but over the same text.
'''
...
def cli(baseline, log, verbose, challenge, entropy_interval):
    '''Pretty-print a comparison of two result logs from an LMChallenge game
